...
public class CardsReader {
	...
	public static List<CardData> readCardsFromCSV() {
		...
		try (BufferedReader br = new BufferedReader(
				new InputStreamReader(CardsReader.class.getClassLoader().getResourceAsStream("cards.csv")))) {
			br.readLine();
			...
			while ((line = br.readLine()) != null) {
				...
				card.setImage(ImageIO
						.read(CardsReader.class.getClassLoader().getResourceAsStream("cards/" + cardData[0] + ".png")));
				...
				case "HOLY":
				case "FIRE":
					card.setTypeIcon(ImageIO.read(CardsReader.class.getClassLoader()
							.getResourceAsStream("cards/" + cardData[6].toLowerCase() + ".png")));
					break;
				default:
					break;
				}
